...
public class CsAcademyFragment extends Fragment {
    private static final String TAG = "CsAcademyFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_csacademy, container, false);
    }

    @Override
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {

        RecyclerView recyclerView = view.findViewById(R.id.csacademy_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        OverScrollDecoratorHelper.setUpOverScroll(recyclerView, OverScrollDecoratorHelper.ORIENTATION_VERTICAL);

        CalenderAdapter calenderAdapter = mainViewModel.getCsacademyAdapter();
        ...
        mainViewModel.getAllContestItems().observe(getViewLifecycleOwner(), new Observer<List<AllContestsItem>>() {
            ...
            public void onChanged(List<AllContestsItem> allContestsItemList) {
                List<AllContestsItem> contestsItems = ContestFilter.contestsFilter((ArrayList<AllContestsItem>) allContestsItemList, ContestFilter.CS_ACADEMY_FILTER);
